...
export default function App() {
  ...
  // Search text normalizer for forgiving search (handles common spellings, coin & bar brand shortcuts)
  const normalizeSearchText = (str: string): string => {
    ...
    return str
      ...
      .replace(/\bkangaroos\b/g, 'kangaroo')
      .replace(/\bmaples\b/g, 'maple')
      .replace(/\beagles\b/g, 'eagle')
      .replace(/\bsovereigns\b/g, 'sovereign')
      .replace(/\bsovs?\b/g, 'sovereign')
      .replace(/\bvrenely\b/g, 'vreneli')
      .replace(/\bvrenelis\b/g, 'vreneli')
      .replace(/\blibertads\b/g, 'libertad')
      .replace(/\bphilharmonics\b/g, 'philharmonic')
      .replace(/\bpandas\b/g, 'panda')
      .replace(/\bkookas?\b/g, 'kookaburra')
      .replace(/\bkookaburras\b/g, 'kookaburra')
      .replace(/\bkoalas\b/g, 'koala')
      .replace(/\belephants\b/g, 'elephant')
      ...
      .replace(/\bmultigrams?\b/g, 'multigram')
      .replace(/\bkinebars?\b/g, 'kinebar')
      .replace(/\bargors?\b/g, 'argor heraeus')
      .replace(/\bvalcambis?\b/g, 'valcambi')
      .replace(/\bmetalors?\b/g, 'metalor')
      .replace(/\bnadirs?\b/g, 'nadir')
      .replace(/\basahis?\b/g, 'asahi')
      .replace(/\bgeigers?\b/g, 'geiger')
      .replace(/\bscottsdales?\b/g, 'scottsdale')
      .replace(/\bstackers?\b/g, 'stacker')
      .replace(/\btombstones?\b/g, 'tombstone')
      .replace(/\bengelhards?\b/g, 'engelhard')
      .replace(/\bjm\b/g, 'johnson matthey')
      .replace(/\bpoured\b/g, 'cast')
      .replace(/[\-\_]/g, ' ')
      .replace(/\s+/g, ' ')
      .trim();
  };
